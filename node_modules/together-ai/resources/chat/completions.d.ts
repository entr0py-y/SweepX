...
export declare namespace CompletionCreateParams {
    interface Message {
         ...
         * format.
         */
        content: string | Array<ChatCompletionsAPI.ChatCompletionStructuredMessageText | ChatCompletionsAPI.ChatCompletionStructuredMessageImageURL | Message.UnionMember2>;
        /**
